...
public class Map1 extends Map {
	...
	private static int[][] tab = {{2,2,2,2,2,2, 2, 2, 2, 2, 2, 1, 1, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2,2,2,2,2,2,2},
			      ...
			      {2,2,2,2,2,2,2, 1, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 2, 11, 2, 2, 12, 12, 12, 12, 14, 3, 3, 14, 12, 12, 12, 12, 12, 12, 11, 11, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 1, 2,2,2,2,2,2,2},
			      {2,2,2,2,2,2,2, 1, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 2, 11, 2, 2, 12, 12, 12, 12, 14, 14, 14, 14, 12, 12, 12, 12, 12, 12, 11, 11, 12, 12, 12, 12, 12, 3, 3, 3, 3, 3, 3, 3, 3, 12, 1, 2,2,2,2,2,2,2},
			      {2,2,2,2,2,2,2, 1, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 2, 11, 2, 2, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 11, 11, 12, 12, 12, 12, 12, 3, 3, 1, 2, 1, 2, 1, 2, 12, 1, 2,2,2,2,2,2,2},
			      {2,2,2,2,2,2,2, 1, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 2, 11, 2, 2, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 11, 11, 12, 12, 12, 12, 12, 3, 12, 12, 12, 12, 12, 12, 12, 12, 1, 2,2,2,2,2,2,2},
	...
	public static void map(TilePane tilePane) {
		for (int i = 0; i < tab.length; i++) {
			for (int j = 0; j < tab[i].length; j++) {
				int tile = tab[i][j];
				setTile(tile,tilePane,12, "assets/images/ImagesMap/herbe.png");
				setTile(tile,tilePane,14, "assets/images/ImagesMap/buisson.png");
				setTile(tile,tilePane,11, "assets/images/ImagesMap/terre.png");
				setTile(tile,tilePane,13, "assets/images/ImagesMap/patte.png");
				setTile(tile,tilePane,1, "assets/images/ImagesMap/arbreFruit.png");
				setTile(tile,tilePane,2, "assets/images/ImagesMap/arbre.png");
				setTile(tile,tilePane,4, "assets/images/ImagesMap/fleur.png");
				setTile(tile,tilePane,3, "assets/images/ImagesMap/roche.png");
			}
		}
	}
} 
